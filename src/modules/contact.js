...
const createContact = ((doc) => {
    const createAbout = () => {
        ...
        const contactImg = createDomElements.createImg('https://images.unsplash.com/photo-1552531268-3fe8c3fc8d84?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80');
        contactImg.setAttribute('id', 'contact-img');
    
        const contactDesc = createDomElements.createParagraph('Our sushi is located is on Ganymede, the greatest moon of Jupiter. Odio voluptatibus nihil expedita aut iure incidunt vitae impedit saepe facere. Eveniet consequuntur laudantium labore expedita.');
    ...
    const createForm = () => {
        ...
        const contactMailLabel = createDomElements.createLabel('Your email adress:', 'contact-mail');
        ...
        const contactMessageLabel = createDomElements.createLabel('Your message:', 'contact-message');
...
const createAdress = () => {
    ...
    mapEmbed.src = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2888.477835903187!2d3.8091240801344073!3d43.617412662864034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12b6ac317b47b909%3A0x9d8496c1217f9864!2sRue%20Ganym%C3%A8de%2C%2034990%20Juvignac!5e0!3m2!1sfr!2sfr!4v1615203259650!5m2!1sfr!2sfr';
